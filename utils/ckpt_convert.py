...
sam_ckpt_path = "./work_dir/SAM/sam_vit_b_01ec64.pth"
medsam_ckpt_path = "/MedSAM/MedSAM/work_dir/MedSAM-ViT-B-PointAndNewBoxPredictor-UnfrozenPromptEncoder-20250725-2352/medsam_model_best.pth"
save_path = "./test.pth"
multi_gpu_ckpt = False  # set as True if the model is trained with multi-gpu

sam_ckpt = torch.load(sam_ckpt_path)
medsam_ckpt = torch.load(medsam_ckpt_path, weights_only=False)
